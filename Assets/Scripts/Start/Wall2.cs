...
public class Wall2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SurfaceMeshesToPlanes.Instance.MakePlanesComplete += MoveWall2;
    ...
    void MoveWall2(object Object, EventArgs e)
    {
        float dimension = 5;
        ...
        this.transform.position = startPlatformPos + new Vector3((-dimension / 2F), 1F, 0F);
