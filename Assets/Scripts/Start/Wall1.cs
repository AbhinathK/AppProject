...
public class Wall1 : MonoBehaviour {
    ...
    void Start () {
        ...
        SurfaceMeshesToPlanes.Instance.MakePlanesComplete += MoveWall1;
    ...
    void MoveWall1(object Object, EventArgs e)
    {
        ...
        this.transform.position = startPlatformPos + new Vector3(dimension / 2, 0.05F, 0F);
