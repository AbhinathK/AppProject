...
public class PatientCylinder : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SurfaceMeshesToPlanes.Instance.MakePlanesComplete += cylinderPatient;
    ...
    public void cylinderPatient(object Object, EventArgs e)
    {
